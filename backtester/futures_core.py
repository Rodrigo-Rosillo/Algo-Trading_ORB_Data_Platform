        ...
        *,
        ...
        if self.side is None and self.pending_signal != 0 and self.pending_due_i == i:
            ...
            if self.risk_mgr is not None and not self.risk_mgr.can_enter(current_date):
                ...
                execution_spec = get_execution_spec(self.execution_specs, self.pending_signal_type)
                required_fields = required_orb_fields(execution_spec)
        ...
        if (
            ...
            if self.risk_mgr is None or self.risk_mgr.can_enter(current_date):
                ...
                step["scheduled"] = True
                execution_spec = get_execution_spec(self.execution_specs, str(signal_type))
