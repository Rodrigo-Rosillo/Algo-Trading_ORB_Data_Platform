...
from tests.helpers import LONG_ENTRY_SIGNAL, LONG_PCT_SIGNAL, build_test_execution_specs
...
def test_spot_engine_executes_percentage_target_from_signal_type_spec() -> None:
    trades, _, _, _ = backtest_orb_strategy(
    ...
    assert trades[0]["signal_type"] == LONG_PCT_SIGNAL
...
def test_futures_core_executes_percentage_target_from_signal_type_spec() -> None:
    ...
    assert core.trades[0]["signal_type"] == LONG_PCT_SIGNAL
